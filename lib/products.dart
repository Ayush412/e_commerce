...
class _listPageState extends State<listPage> {
  ...
  navigateToDetail(DocumentSnapshot post){
    ...
    Navigator.push(context, PageRouteBuilder(transitionDuration: Duration(milliseconds:600) ,pageBuilder: (_,__,___)=> prodDescription(post: post, email: email, counter: _counter, userpost: widget.post,)));
  }
        ...
        body: Stack(
            ...
            Positioned(
              ...
              BottomNavigationBarItem(
                ...
                title: Text('Sort', style: TextStyle(color: Colors.grey),)
              ),
              BottomNavigationBarItem(
              ...
              BottomNavigationBarItem(
                ...
                title: Text('Sub Category', style: TextStyle(color: Colors.grey),)
              ),
              ],
              currentIndex: 0,
              onTap: (int index) async {
                if(index == 0){
                  ...
                  switch (sortVal){
                    ...
                    color: Colors.black,
                    context: context,
                    position: RelativeRect.fromLTRB(30.0, 515.0, 30.0, 0.0), //38.0, 555.0, 10.0, 0.0
